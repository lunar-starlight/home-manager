...
(deflayer agda1
  ...
  del  end  pgdn   kp7  kp8  kp9  kp+  
                   kp4  kp5  kp6       
       up          kp1  kp2  kp3  kprt 
  left down rght   kp0       102d      )
(deflayer agda2
  S-esc  f1   f2   f3   f4   f5   f6   f7   f8   f9   f10  f11  f12          
  ?      $    7    5    3    1    9    0    2    4    6    8    "  S-bspc    
  S-tab  Q    W    E    R    T    Y    U    I    O    P    \_   ;    S-@ž    
  S-lctl A    S    D    F    G    H    J    K    L    S-@č S-@š S-ret        
  XX     Z    X    C    V    B    N    M    /    @    :    XX                
  S-lctl S-lmet S-lalt         S-spc       S-@lspe @lsup                        
  ...
  S-left S-down   S-rght   S-kp0         S-102d        )
(deflayer latexctl
  esc  f1   f2   f3   f4   f5   f6   f7   f8   f9   f10  f11  f12        
...
(deflayer special
  ...
  _      _      @š     _      _      _      _      _      _      _      =      grv    _           
  rsft   @ž     @x     @č     _      _      _      _      _      @.s    @norm  rsft               
  _      _      _                    _                    XX     @lgre                            
...
(deflayer superscript
  ...
  rsft @supz  @supx  @supc  @supv  @supb  @supn  @supm  <      >      _      rsft               
  _    _      _                    _                    _      _                         
